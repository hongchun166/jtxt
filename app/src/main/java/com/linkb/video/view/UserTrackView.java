...
public class UserTrackView extends FrameLayout {
    ...
    private WebImageView avatarImg;
    ...
    public void setUserTrackInfo(QNRTCEngine engine, String userId, List<QNTrackInfo> trackInfos, int microphoneViewVisibility) {
        ...
        if (avatarImg != null) {
            avatarImg.load(FileURLBuilder.getUserIconUrl(mUserId), R.mipmap.lianxiren, 999);
        }

        Friend friend = FriendRepository.queryFriend(mUserId);
        mAudioView.setText(TextUtils.isEmpty(friend.name) ? mUserId : friend.name);
    ...
    protected void onFinishInflate() {
        ...
        avatarImg = (WebImageView) findViewById(R.id.avatar_img);
