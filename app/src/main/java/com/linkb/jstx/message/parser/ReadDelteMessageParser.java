...
public class ReadDelteMessageParser extends MessageParser {
    ...
    public void getMessagePreviewText(Message message, EmoticonTextView textView) {
        ...
        if (message.format.equals(Constant.MessageFormat.FORMAT_RED_PACKET)){
            ...
            textView.setText(content);
             ...
             if(message.action.equals(Constant.MessageAction.ACTION_ReadDelete)){
                 if(self){
                     textView.setText(str);
                 }else {
                     textView.setText(R.string.label_message_preview_readDelete);
                 }
            }else {
                 textView.setText(str);
             }
