...
/**  群组成员选择(多选)
* */
public class GroupMenberAdapter extends RecyclerView.Adapter<GroupMenberAdapter.GroupMenberViewHolder> {
    ...
    @NonNull
    @Override
    public GroupMenberAdapter.GroupMenberViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull GroupMenberAdapter.GroupMenberViewHolder viewHolder, int i) {
